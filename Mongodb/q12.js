...
// mongod --configsvr --port 27018 --replSet cf --dbpath S:\dbshards\conf
...
// mongod --shardsvr --port 27023 --replSet rs2 --dbpath S:\dbshards\s2r
...
//mongos - is mongodb routing service
/////////////////////////
